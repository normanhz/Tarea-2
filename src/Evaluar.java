...
public class Evaluar {
	...
	@Test
	public void getsumaNorman()
	{
		assertEquals("Rrror calculando getsumaNorman(3,4)", 7, MiClase.suma(3,4));
		
	}
	
	@Test
	public void getrestaNorman()
	{
		assertEquals("Rrror calculando getrestaNorman(8,5)", 3, MiClase.resta(8,5));
